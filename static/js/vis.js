freq_url = window.location.href + "/api/freq_table";
...
(function() {
    ...
    FreqMap = function() {
        ...
        freqMap = (function(_this) {
            return function(selection, data) {
                ...
                return d3.json(window.location.href + '/static/data/world-110m.json', function(error, world) {
    ...
    $(function() {
        ...
        newPDF = function() {
            ...
            xml.open('GET', 'css/fonts/Arvo-Regular.ttf', true);
            xml2.open('GET', 'css/fonts/Arvo-Italic.ttf', true);
